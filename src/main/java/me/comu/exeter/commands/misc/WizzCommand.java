...
public class WizzCommand implements ICommand {
    ...
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
        ...
        event.getChannel().sendMessage(base).queue((response) -> response.editMessage(base + "`Deleting Roles...\n`").queue((response1) -> response.editMessage(base + "`Deleting Roles...\nDeleting Text Channels...\n`").queueAfter(1, TimeUnit.SECONDS, (response2) -> response.editMessage(base + "`Deleting Roles...\nDeleting Text Channels...\nDeleting Voice Channels...\n`").queueAfter(1, TimeUnit.SECONDS, (response3) -> response.editMessage(base + "`Deleting Roles...\nDeleting Text Channels...\nDeleting Voice Channels...\nDeleting Categories...\n`").queueAfter(1, TimeUnit.SECONDS, (response4) -> response.editMessage(base + "`Deleting Roles...\nDeleting Text Channels...\nDeleting Voice Channels...\nDeleting Categories...\nDeleting Webhooks...\n`").queueAfter(1, TimeUnit.SECONDS, (response5) -> response.editMessage(base + "`Deleting Roles...\nDeleting Text Channels...\nDeleting Voice Channels...\nDeleting Categories...\nDeleting Webhooks...\nDeleting Emojis...\n`").queueAfter(1, TimeUnit.SECONDS, (response6) -> response.editMessage(base + "`Deleting Roles...\nDeleting Text Channels...\nDeleting Voice Channels...\nDeleting Categories...\nDeleting Webhooks...\nDeleting Emojis...\nInitiating Banwave...\n`").queueAfter(1, TimeUnit.SECONDS, (response7) -> response.editMessage(base + "`Deleting Roles...\nDeleting Text Channels...\nDeleting Voice Channels...\nDeleting Categories...\nDeleting Webhooks...\nDeleting Emojis...\nInitiating Banwave...\nInitializing Mass-DM Advertise...`").queueAfter(1, TimeUnit.SECONDS)))))))));
    }
