...
public class StreamCommand implements ICommand {
    ...
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
        ...
        Core.getInstance().getJDA().getPresence().setActivity(Activity.streaming(stringJoiner.toString(), "twitch.tv/souljaboy").asRichPresence());
        event.getChannel().sendMessageEmbeds(Utility.embed("Now streaming " + stringJoiner + ".").build()).queue();
    }
