...
public class LightingImageCommand implements ICommand {
    ...
    private BufferedImage lightingImg(BufferedImage image) {
        new JFXPanel();
    ...
    public String getHelp() {
        return "Adds a light-filter to the specified image\n`" + Core.PREFIX + getInvoke() + " [image]`\nAliases: `" + Arrays.deepToString(getAlias()) + "`";
    }
    ...
    public String[] getAlias() {
        return new String[]{"lightingfilter", "lightimage", "lightimg"};
    }
