...
public class TrumpTweetImageCommand implements ICommand {
    ...
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
        ...
        String url = "https://nekobot.xyz/api/imagegen?type=trumptweet&text=" + String.join(" ", args).replaceAll(" ", "%20");
    ...
    public String getHelp() {
        return "Makes a tweet by Donald J. Trump\n`" + Core.PREFIX + getInvoke() + " [message]`\nAliases: `" + Arrays.deepToString(getAlias()) + "`";
    }
    ...
    public String[] getAlias() {
        return new String[] {"trump", "tweettrump"};
    }
