...
public class WhatImageCommand implements ICommand {


    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
        String url = "https://api.alexflipnote.dev/what?image=";
    ...
    public String getHelp() {
        return "Interpolates the groundbend meme\n`" + Core.PREFIX + getInvoke() + " [user/image]`\nAliases: `" + Arrays.deepToString(getAlias()) + "`";
    }
    ...
    public String[] getAlias() {
        return new String[] {"whatimage","whatimg","whatify"};
    }
