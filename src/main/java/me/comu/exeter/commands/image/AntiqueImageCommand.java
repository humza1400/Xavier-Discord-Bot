...
public class AntiqueImageCommand implements ICommand {
    ...
    public String getHelp() {
        return "Adds an antique-like filter to the specified image\n`" + Core.PREFIX + getInvoke() + " [image]`\nAliases: `" + Arrays.deepToString(getAlias()) + "`";
    }
    ...
    public String[] getAlias() {
        return new String[]{"antqueimage", "antiqueimg", "antiquefilter"};
    }
