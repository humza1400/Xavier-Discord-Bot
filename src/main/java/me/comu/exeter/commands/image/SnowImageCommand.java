...
public class SnowImageCommand implements ICommand {


    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
        String url = "https://api.alexflipnote.dev/filter/snow?image=";
    ...
    public String[] getAlias() {
        return new String[] {"snowimage","snowimg","snowify"};
    }
