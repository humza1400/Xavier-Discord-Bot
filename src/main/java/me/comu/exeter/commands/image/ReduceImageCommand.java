...
public class ReduceImageCommand implements ICommand {
    ...
    private BufferedImage resizeImage(final Image image) {
        final BufferedImage bufferedImage = new BufferedImage(100, 100, BufferedImage.TYPE_INT_RGB);
    ...
    public String[] getAlias() {
        return new String[]{"reduceimage","shrink", "reduceimg", "shortenimage", "shortenimg", "smaller", "smallerimage", "smallerimg"};
    }
