...
public class ThreatImageCommand implements ICommand {
    ...
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
        ...
        {
            event.getChannel().sendMessage("Please specify an image to threat-ify").queue();
        }
        String url = "https://nekobot.xyz/api/imagegen?type=threats&url=";
    ...
    public String getHelp() {
        return "Threat-ify the specified image\n`" + Core.PREFIX + getInvoke() + " [image]`\nAliases: `" + Arrays.deepToString(getAlias()) + "`";
    }
