...
public class PixelatetImageCommand implements ICommand {


    @Override
    public void handle(List<String> args, GuildMessageReceivedEvent event) {
        String url = "https://api.alexflipnote.dev/filter/pixelate?image=";
    ...
    public String getHelp() {
        return "Pixelates the specified image\n`" + Core.PREFIX + getInvoke() + " [image]`\nAliases: `" + Arrays.deepToString(getAlias()) + "`";
    }
    ...
    public String[] getAlias() {
        return new String[]{"pixel", "imagepixelate", "imgpixelate", "pixelateimage", "pixelateimg"};
    }
